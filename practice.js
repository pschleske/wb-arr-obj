...
* Determine the value of oldEnough on the first line of the function below
* Run the code to see if you're correct
*/
function checkAge(age) {
  const oldEnough = age >= 21 ? 'Yup' : 'Nope';
...
// Complete the messageBasedOnAge function by using ternary statements to return a string based on the age parameter.
